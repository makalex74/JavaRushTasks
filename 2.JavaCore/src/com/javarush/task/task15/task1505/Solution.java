...
public class Solution {
    ...
    public static class Finger extends BodyPart {
        ...
        public Object containsBones() {
            String superContainsBones = "";
            if (super.containsBones() instanceof String)
              superContainsBones = (String) super.containsBones();
/*            System.out.println(superContainsBones);
            System.out.println(isArtificial);
            System.out.println(superContainsBones.equals("Yes")  && isArtificial);*/
            if (superContainsBones.equals("Yes")  && !isArtificial)
               return "Yes";
            else
                return "No";
        }
