...
/*    @Override
    ...
    public static void main(String[] args) {
        Solution sol = new Solution(1,"Бубу", 1d, new Date(), null);
        Set<Solution> s = new HashSet<>();
        s.add(new Solution(1,"Бубу", 1d, new Date(), sol));
        System.out.println(s.contains(new Solution(1,"Бубу", 1d, new Date(), sol)));
    }
}
