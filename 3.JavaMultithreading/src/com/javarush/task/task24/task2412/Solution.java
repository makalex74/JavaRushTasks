            ...
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (value != 0)
                    ...
                    if (value != 0)
                        ...
                        profit[0] = stock1.containsKey("open") ? (Double) stock1.get("last") - (Double) stock1.get("open") : (Double) stock1.get("change");
                        profit[1] = stock2.containsKey("open") ? (Double) stock2.get("last") - (Double) stock2.get("open") : (Double) stock2.get("change");
