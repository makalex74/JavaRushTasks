...
public class DirectorTablet {
    ...
    public void printActiveVideoSet() {
        ...
        List<Advertisement> listActive = manager.getVideoSet(true);
        ...
        for (Advertisement advertisement:listActive) {
    ...
    public void printArchivedVideoSet() {
        StatisticAdvertisementManager manager = StatisticAdvertisementManager.getInstance();
        List<Advertisement> listArchived = manager.getVideoSet(false);
        Collections.sort(listArchived, new Comparator<Advertisement>() {
            @Override
            public int compare(Advertisement o1, Advertisement o2) {
                return o1.getName().toLowerCase().compareTo(o2.getName().toLowerCase());
            }
        });
        for (Advertisement advertisement:listArchived) {
