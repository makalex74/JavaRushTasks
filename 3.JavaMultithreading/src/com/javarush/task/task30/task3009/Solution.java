    ...
    private static Set<Integer> getRadix (String number){
        ...
        for (int numberSystem = 2; numberSystem <=36 ; numberSystem++) {
            try {
                ...
                String convertedDigitStringReverse = new StringBuilder(convertedDigitString).reverse().toString();
                if (convertedDigitString.equals(convertedDigitStringReverse)) {
                    //System.out.println(numberSystem + " " + convertedDigitString);
                    result.add(numberSystem);
                }
