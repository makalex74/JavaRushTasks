...
public class Solution {
    public static void main(String[] args) throws IOException {
        //args = "ztest//task3105//source_file3.txt ztest//task3105//yesterday.zip".split(" ");
        //Получаем список файлов из архива ztest//task3105//yesterday.zip
        List<Content> entries = getContents(args[1]);

        //Поток для записи в zip-файл ztest//task3105//yesterday.zip (Посути пересоздаем файл!)
        FileOutputStream zipFile = new FileOutputStream(args[1]);
        ZipOutputStream zip = new ZipOutputStream(zipFile);

        // Файл ztest//task3105//source_file3.txt
        File file = new File(args[0]);

        //кладем в zip-файл yesterday.zip ZipEntry –«архивный объект» с именем new/source_file3.txt
        zip.putNextEntry(new ZipEntry("new/" + file.getName()));

        //копируем файл «ztest//task3105//source_file3.txt» в архив под именем «new/source_file3.txt»
