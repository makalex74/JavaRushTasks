...
public class Solution {
    public static void main(String[] args) throws IOException {
        Path path1 = Paths.get("D://IdeaProjects//JavaRushTasks//ztest//task3108//test//data//firstDir");
        Path path2 = Paths.get("D://IdeaProjects//JavaRushTasks//ztest//task3108//test//data//secondDir//third");
