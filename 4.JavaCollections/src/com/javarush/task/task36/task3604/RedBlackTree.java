 ...
 */
    ...
    public String toString() {
        return "RedBlackTree{" +
                "current=(" + current.element + " " +  current.color + ")" +
                ", parent=(" + parent.element + " " + parent.color + ")" +
                ", grand=(" + grand.element + " " + grand.color + ")" +
                ", great=(" + great.element + " " + great.color + ")" +
                ", header=(" + header.element + " " + header.color + ")" +
                '}';
    }
}
